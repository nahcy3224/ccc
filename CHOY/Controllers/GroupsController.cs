...
namespace CHOY.Controllers
{
    public class GroupsController : Controller
    {
        ...
        {
            var me = "M0001";
            var groups = db.Groups.Include(g => g.Member).Where(m=>m.MemberID==me);
       ...
       // [ValidateAntiForgeryToken]
        ...
        public ActionResult CreateMemberInGroups(string gid,string mid)
        {
            ...
            //ViewBag.MemberID = new SelectList(db.Members, "MemberID", "Email", groupmember.MemberIDOwner);
        ...
        //[ChildActionOnly]
        //[ValidateAntiForgeryToken]
        public ActionResult CreateMemberInGroups(GroupMember groupmember, string gid, string mid,string Id)
        {
